...
public class AESSymmetricEncryption {
    ...
    /*public static void main(String[] args) {
        try {
            ...
            // Decrypt data
            String decryptedText = decrypt(encryptedText, secretKey2);
            ...
            String encryptedText = crypto.encryptAsString(plainText, crypto.secretKey);
            System.out.println("Encrypted Value "+encryptedText);
            String decryptedText = crypto.decrypt(encryptedText, crypto.secretKey);
            System.out.println("decryptedText Value "+decryptedText);

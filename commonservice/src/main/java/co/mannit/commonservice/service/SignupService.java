...
public class SignupService {
    ...
    public String signupUser(String registrationDetails) throws Exception {
        ...
        String password = String
                .valueOf(valueExtracterFromJSON.getValue(registrationDetails, "password", String.class));
        ...
        String subDomain = String
                .valueOf(valueExtracterFromJSON.getValue(registrationDetails, "subdomain", String.class));
...
//		if(!StringUtils.hasText(userName) || !StringUtils.hasText(email) || !StringUtils.hasText(password)) {
        ...
        if (!StringUtils.hasText(String.valueOf(mobileno)) || !ptrn.matcher(String.valueOf(mobileno)).matches()) {
        ...
        if (logisignupassDao.isUserAlreadyExist("username", userName)) {
            throw new ServiceCommonException("104", new String[] { "User name" });
        }

        if (logisignupassDao.isUserAlreadyExist("mobileno", mobileno)) {
        ...
        keyValuePairs.add(new MongokeyvaluePair<String>("password",

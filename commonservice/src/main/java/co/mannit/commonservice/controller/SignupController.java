...
public class SignupController {
    ...
    public Response<?> login(@RequestBody String loginDetails) throws Exception {
        ...
        String msg = loginService.login(loginDetails);
        logger.debug("</register>");
        return Response.buildSuccessMsg(200, msg, null);
    }

    /*
     * @GetMapping("forgetpassword") public Response<?> verifyotp(@RequestBody
     * String loginDetails, @PathVariable String method) throws Exception {
     * logger.debug("<verifyotp> {} ",loginDetails); String msg =
     * logisignupassService.verifyOTP(loginDetails, LoginMethod.value(method));
     * logger.debug("</verifyotp>"); return Response.buildSuccessMsg(200, msg,
     * null); }
     */
